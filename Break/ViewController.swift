...
//  Break
//
//  Created by William McDuff on 1/28/15.
...
//        collisionBehavior.translatesReferenceBoundsIntoBoundary = true
        ...
        print(collisionBehavior.boundaryIdentifiers)
    ...
    func endGame(gameOver: Bool) {
        ...
        print(GameData.mainData().currentLevel)
        
        print(GameData.mainData().gamesPlayed)
        print(GameData.mainData().topScore)
    ...
    func createBall() {
        ...
        let ball = UIView(frame: CGRectMake(0, 0, 20, 20))
    ...
    func createBricks() {
        ...
        let gap: CGFloat = 10
        let width = (SCREEN_WIDTH - (gap * CGFloat(grid.0 + 1))) / CGFloat(grid.0)
        ...
        for c in 0..<grid.0 {
            ...
            for r in 0..<grid.1 {
                ...
                let x = CGFloat(c) * (width + gap) + gap
                let y = CGFloat(r) * (height + gap) + 70
